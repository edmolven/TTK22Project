...
"""autogenerated by genpy from custom_msgs/HalfspaceDescription.msg. Do not edit."""
import sys
...
class HalfspaceDescription(genpy.Message):
  _md5sum = "77bfbd60980c2f9a2cd09f881bcff234"
  _type = "custom_msgs/HalfspaceDescription"
  _has_header = False #flag to mark the presence of a Header object
  _full_text = """# Describes halfspace s.t. Ax <= b is within the halfspace.
float64[] A
float64[] b"""
  __slots__ = ['A','b']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(HalfspaceDescription, self).__init__(*args, **kwds)
