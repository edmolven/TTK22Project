...
(cl:defmethod cl:initialize-instance :after ((m <orientationEuler>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'orientationEuler)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name custom_msgs-msg:<orientationEuler> is deprecated: use custom_msgs-msg:orientationEuler instead.")))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<orientationEuler>)))
  ...
  (cl:format cl:nil "# This is a message to hold orientation data. No header~%~%float64 roll~%float64 pitch~%float64 yaw~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'orientationEuler)))
  "Returns full string definition for message of type 'orientationEuler"
  (cl:format cl:nil "# This is a message to hold orientation data. No header~%~%float64 roll~%float64 pitch~%float64 yaw~%~%~%~%"))
